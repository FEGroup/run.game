run.Hero = (function () {
<<<<<<< HEAD:app/scripts/view/run.Hero.js
  'use strict';
...
=======
    ...
    return run.Class.extend({
        ...
        _draw: function () {
            ...
            var x = this.model.get('x');
            var y = this.model.get('y');
            this._ctx.drawImage(run.Sources[this._name].imageObj, pos[0], pos[1], pos[2], pos[3], x, y, pos[2] * this.scale, pos[3] * this.scale);
        },
...
>>>>>>> 27cfb1c3179549e7a68dc43708dfa2f7af030726:app/scripts/viewControl/run.Hero.js
})();
