run.Hero = (function () {
  ...
  return run.Class.extend({
    ...
    _draw: function () {
      var rectArr = this.getSrc(this.mode, this._name);

      this._ctx.drawImage(run.Sources[this._name].imageObj,
        rectArr[this._currentFrame][0], rectArr[this._currentFrame][1], rectArr[this._currentFrame][2], rectArr[this._currentFrame][3],
        this.model.get('x'), this.model.get('y'), rectArr[this._currentFrame][2] * this.scale, rectArr[this._currentFrame][3] * this.scale);
    },
